...
init python:
    ...
    splash_message_default = "Это неофициальное фанатское дополнение, никак не связанное с Team Salvato.\n\nникаких позеров"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "{b}Внимание:{/b} данная модификация содержит огромное количество непереводимой лексики (названия групп, альбомов, названия песен, тексты песен, каламбуры названий песен)."
        "Поэтому качество данных строк будет гораздо ниже, чем обычно."
        "Также она содержит {b}{i}очень большое{/i}{/b} количество профанации (матов, иными словами). Больше, чем во всех наших прошлых модах {i}вместе взятых{/i}."
        "Поэтому если вы проходите его на стриме или в качестве видео на YouTube, не удивляйтесь, если вам за него вставят 18+."
