...
Not all good times must come to an end."""
    ...
    poem_metal_s1 = Poem(
    author = "sayori",
    title = "Я Хочу Выбраться",
    text = """\
Начиная прям с рождения
Мы все загнаны в угол
Всем пофиг на то, какими мы будем
В школах нас учат правильно думать
Но все говорят очень разное
И все они свято убеждены
Что именно они самые важные
Они лишь говорят, и их не остановить
И в какой-то момент ты сдаёшься
Так что единственное, что остаётся

Я хочу выбраться
Чтобы просто прожить свою жизнь
Я хочу выбраться
Просто отстаньте от меня
Я хочу выбраться
Чтобы просто делать всё сама по себе
Я хочу выбраться

А ещё я хочу завтракать."""
    )
